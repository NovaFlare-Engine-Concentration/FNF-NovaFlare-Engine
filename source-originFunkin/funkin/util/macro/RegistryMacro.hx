...
class RegistryMacro
{
  ...
  static function listBaseGameEntryIds(dataFilePath:String):Array<Expr>
  {
    ...
    // originFunkin assets are supplied next to the executable, not inside the
    // source checkout used by this build macro. Runtime registry enumeration
    // still reads every mounted JSON entry through DataAssets.
