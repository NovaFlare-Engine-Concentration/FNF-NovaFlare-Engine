...
class TouchUtil
{
  ...
  {
    if (TouchUtil.touch == null || ticksSincePress() > 200) return false;
  ...
  public static inline function ticksSincePress():Int
  {
    if (touch == null) return 0x3FFFFFFF;
    return FlxG.game.ticks - touch.justPressedTimeInTicks;
  }
